             ...
             <div class="banner-content-wrap">
                <div class="container">
                   <div class="banner-content text-center">
                      ...
                      <p>Embark on seamless adventures with STG Explorer - Register now to unlock the smart way to plan your personalized tours</p>
             ...
             <div class="banner-content-wrap">
                <div class="container">
                   <div class="banner-content text-center">
                      ...
                      <p>Join us to register and design your unique travel itinerary. Your adventure, your plan – only with Smart Tour Guide.</p>
                      <a href="#" class="button-primary">CONTINUE READING</a>
                   </div>
                </div>
             </div>
       ...
       <div class="section-heading text-center">
          <div class="row">
             <div class="col-lg-8 offset-lg-2">
                ...
                <p>Login and register to the platform and plan your own tour iternity with our advance feature to make your tour well managed and organized.</p>
             </div>
          </div>
       </div>
       ...
       <div class="row">
          <div class="col-lg-5">
             <div class="section-heading">
                ...
                <p>Join our vibrant community of explorers and share your unforgettable moments with STG Explorer. Your experiences not only enrich our platform but inspire fellow travelers on their own extraordinary journeys.</p>
             </div>
