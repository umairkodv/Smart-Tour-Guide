        ...
        <div class="login-from-wrap" style="">
            ...
            <form method="POST" action="{{ route('register') }}" class="login-from" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="user_type" id="user_type" class="form-controll" required onchange="showFields()">
            ...
            <div class="col-6">
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input type="text" name="country" class="fomr-controll" placeholder="enter you country name">
                    </div>
                    <div class="col form-group">
                        <label for="">State <b style="color: red">*</b></label>
                        <input type="text" name="state" placeholder="enter your state name" class="fomr-controll">
                    </div>
                </div>
                <div class="row">
                    <div class="col form-group">
                    ...
                    <div class="col form-group">
                        ...
                        <input type="number" name="phone" placeholder="enter your phone no" class="fomr-controll">
                    </div>
                </div>
                ...
                <div id="touristFields" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="place_type" id="place_type" class="form-controll" required onchange="showFields()">
                    ...
                    <div class="form-group">
                        ...
                        <select name="food_type" id="food_type" class="form-controll" required onchange="showFields()">
                    ...
                    <div class="form-group">
                        ...
                        <select name="accomodation_type" id="accomodation_type" class="form-controll" required onchange="showFields()">
                ...
                <div id="driverFields" style="display: none; overflow-y: scroll;overflow-x: hidden; height: 600px; padding 15px">
                    <!-- Driver Fields -->
                    <div class="row">
                        <div class="form-group col">
                            <label for="">Age <b style="color: red">*</b></label>
                            <input type="number" name="age" placeholder="enter your age" class="fomr-controll">
                        </div>
                        <div class="form-group col">
                            <label for="">CNIC (without brackets) <b style="color: red">*</b></label>
                            <input type="number" name="cnic" placeholder="enter your cnic" class="fomr-controll">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="">Address <b style="color: red">*</b></label>
                        <input type="text" name="address" placeholder="enter your complete address" class="fomr-controll">
                    </div>
                    <div class="form-group">
                        <label for="">Location <b style="color: red">*</b></label>
                        <input type="text" name="location" placeholder="enter your complete address" class="fomr-controll">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" name="price_per_day" placeholder="enter price per day" class="fomr-controll">
                        </div>
                        <div class="form-group col">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" name="model" placeholder="enter car model" class="fomr-controll">
                        </div>
                        <div class="form-group col">
                            <label for="">Manufacturer <b style="color: red">*</b></label>
                            <input type="text" name="manufacturer" placeholder="enter car manufacturer" class="fomr-controll">
                        </div>
                    </div>
                </div>
