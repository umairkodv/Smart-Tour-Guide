        ...
        <div id="dashboard" class="dashboard-container">
            <div class="dashboard-header sticky-header">
                <div class="content-left  logo-section pull-left">
                    <h1><a href="{{ url('/') }}"><img style="width: 32%" src="{{ asset('assets2/images/logo.png') }}" alt=""></a></h1>
                </div>
                <div class="heaer-content-right pull-right">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu account-menu">
                            <ul>
                                <li><a href="{{ route('password.change') }}"><i class="fas fa-key"></i>Password</a></li>
                ...
                <div id="navigation" class="navigation-container">
                    <ul>
                        ...
                        @if (Auth::check()&&Auth::user()->user_type=='Admin')
                            ...
                            <li><a href="{{ route('admin.trips.all') }}"><i class="fas fa-umbrella-beach"></i> Trips & Plans</a></li>
                        ...
                        @if (Auth::check()&&Auth::user()->user_type=='Tourist')
                            <li class="active-menu"><a href="{{route('tourist.dashboard')}}"><i class="far fa-chart-bar"></i> Dashboard</a></li>
                            <li><a href="{{route('tourist.trips')}}"><i class="fas fa-ticket-alt"></i>My Trips</a></li>
                        @endif
                        @if (Auth::check()&&Auth::user()->user_type=='Driver')
                        <li><a href="{{ route('driver.dashboard') }}"><i class="far fa-chart-bar"></i>Dashbaord</a></li>
                        @endif
                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
